  ...
  render () {
    return (
      <div> 
        ...
        <Icon name='tree' size="big" textAlign='center' fitted /> <Icon name='tree' size="huge" textAlign='center' fitted /><Icon name='tree' size="big" textAlign='center' fitted />
          </Container>
        ...
        <br />
        <Container textAlign='center'>
        <Button primary content='Get Started' textAlign='center' icon='right arrow' size="medium" labelPosition='right' as={Link} to='/sights' />
        </Container>
        </Container>     
      </div>
    );
