        ...
        <Container style={{ marginTop: '1em' }}>        
          ...
          <Grid container stackable verticalAlign='middle'>
            <Grid.Column width={8}>
                ...
                <p>Today, Yellowstone National Park protects over 2.2 million acres in Montana, Idaho, and Wyoming. Yellowstone is well known for its diverse populations of flora and fauna and its hundred of unique ‘other-worldy’ geothermal features. The park contains over 300 active geysers, 150 of which are concentrated in a one square mile, making this area the most densely populated geyser region in the world.</p>
                <p> We hope you enjoy your experience while navigating the Yellowstone Odyssey and learning more about the United States first national park!</p>
                <YNP />
            </Grid.Column>
